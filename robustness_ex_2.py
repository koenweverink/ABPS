...
def main():
    ...
    cfg = {
        ...
        "checkpoint_every": 1,
        "resume_from": None,
        "best_path": "robustness2.pkl",
        "checkpoint_path": "robustness2_chkpt.pkl",
    ...
    with open("robustness_ex2.json", "w", encoding="utf-8") as f:
        json.dump({"cfg_used": cfg, "result": res}, f, indent=2, default=str)
    with open("robustness_summary_ex2.json", "w", encoding="utf-8") as f:
