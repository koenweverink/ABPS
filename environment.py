...
forest_edge = [
    pos for pos in forest
    if any(n not in forest for n in neighbors(pos, in_bounds, river=river, cliffs=cliffs, climb_entries=climb_entries))
]
