...
def main():
    ...
    cfg = {
        ...
        "checkpoint_every": 1,
        "resume_from": None,
        "best_path": "robustness.pkl",
        "checkpoint_path": "robustness",
    ...
    with open("robustness.json", "w", encoding="utf-8") as f:
        json.dump({"cfg_used": cfg, "result": res}, f, indent=2, default=str)
    with open("robustness_summary.json", "w", encoding="utf-8") as f:
